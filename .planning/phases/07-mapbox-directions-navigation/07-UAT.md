...
- **Expected Result:** Estimated travel time, arrival timestamp, and route steps dynamically recalculate based on the selected mode (e.g. driving ~40 km/h, walking ~5 km/h).
- **Status:** Pending User Confirmation
